...
class Login_Win:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"Hotel_Management_System_DBMS_MINI_Project\images\login.jpg")
        lbl_bg=Label(self.root,image=self.bg)
        lbl_bg.place(x=0,y=0,relwidth=1,relheight=1)
        
        frame=Frame(self.root,bg="black",borderwidth=0)
        frame.place(x=610,y=170,width=340,height=450)

        img1=Image.open(r"Hotel_Management_System_DBMS_MINI_Project\images\img1.jpg")
        ...
        img2=Image.open(r"Hotel_Management_System_DBMS_MINI_Project\images\email.jps.jpg")
        ...
        img3=Image.open(r"Hotel_Management_System_DBMS_MINI_Project\images\pass.jpg")
...
class Register:
    def __init__(self,root):
        ...
        frame.place(x=400,y=100,width=770,height=550)
